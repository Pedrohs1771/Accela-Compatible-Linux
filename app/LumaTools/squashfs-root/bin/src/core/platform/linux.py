...
class LinuxBackend(PlatformBackend):
    ...
    def describe_steam_install(self) -> SteamInstall:
        ...
        for root in roots:
            ...
            # Check both steamapps/libraryfolders.vdf and config/libraryfolders.vdf
            # depending on Steam version/mode
            vdf_candidates = [
                Path(root_str) / "steamapps" / "libraryfolders.vdf",
                Path(root_str) / "config" / "libraryfolders.vdf"
            ]
