...
class ChmodResumeDialog(QDialog):
    ...
    def __init__(self, game_name, file_count, success, parent=None):
        ...
        self.setWindowTitle("Permissões executáveis concluídas")
    ...
    def _setup_ui(self, game_name, file_count, success):
        ...
        # Title
        title = ScaledFontLabel("Permissões executáveis concluídas")
        ...
        # Files processed
        processed_label = ScaledLabel(f"Arquivos processados: {file_count}")
        ...
        if success and file_count > 0:
            ...
            status_text = "Todas as permissões foram definidas"
            status_color = "#00FF00"
        elif file_count == 0:
            status_text = "Nenhum arquivo executável encontrado"
            status_color = "#888888"
        else:
            status_text = "Falha na operação"
            status_color = "#FF6B6B"
